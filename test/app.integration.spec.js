...
describe('Test routes', () => {
  ...
  it('POST /bookmarks handles error', (done) => {
  ...
  it('POST /bookmarks handles success', (done) => {
  ...
  describe('GET /bookmarks/:id', () => {
    ...
    it('GET /bookmarks/:id handles error', (done) => {
    ...
    it('GET /bookmarks/:id handles success', (done) => {
